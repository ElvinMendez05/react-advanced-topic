...
import { getInitialState, scrambkeWordsReducer } from './scrumbleWordReducer';


export const ScrumbleWords = () => {
  
  
 const [state, dispatch] = useReducer(scrambkeWordsReducer, getInitialState())
